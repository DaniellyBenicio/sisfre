...
//Feriados nacionais onde é certeza de que não haverá mudança de data.
...
async function seedHolidays(startYear, endYear) {
  for (let year = startYear; year <= endYear; year++) {
    ...
    console.log(`Feriados de ${year} inseridos.`);
  }
  process.exit(0);
}

// Para manutenibilidade, é só alterar os anos aqui e rodar o script novamente.
seedHolidays(2025, 2026);