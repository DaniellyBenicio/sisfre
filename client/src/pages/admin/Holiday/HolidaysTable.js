...
const HolidaysTable = ({ holidays, onDelete, onUpdate, search, setAlert, loading, isFiltered }) => {
  ...
  const renderMobileRow = (holidayItem) => (
    <Stack spacing={0.5}>
      <Typography>
        <strong>Data:</strong> {holidayItem.date}
      </Typography>
      <Typography>
  ...
  return (
    <DataTable
      ...
      setAlert={setAlert}
      isFiltered={isFiltered} // Passar a nova prop
    />
  );
};
