...
module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    console.log(
      `Registros para o curso Mecatrônica Industrial removidos com sucesso.`
    );
  },
};
