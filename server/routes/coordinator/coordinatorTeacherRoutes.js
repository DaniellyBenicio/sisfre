...
import { getAbsencesByDiscipline, updateAbsenceByTurn } from "../../controllers/coordinator/coordinatorAttendanceController.js";
...
router.put('/absences/turn', autenticarToken, isAdminOrCoordinator(), updateAbsenceByTurn);
